  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="address in addressInfo" :key="address.id">
        ...
        <p>
          <span class="s1" @click="changeDefault(address,addressInfo)">{{address.fullAddress}}</span>
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        ...
        <span>手机号：{{userDefaultAddress.phoneNum}}</span>
      </div>
    </div>
...
import { mapState } from 'vuex';
  export default {
    ...
    methods:{
      ...
      // 提交订单
    async  submitOrder(){
        // 需要携带参数:tradeNo交易编码  data 其余的6个参数
